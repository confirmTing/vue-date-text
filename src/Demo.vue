<template>
  <div id="app">
    ...
    <div class="example">
      ...
      <datepicker v-model="vModelExample" ref="datepicker" :disabled="disabled" :selected="disableTo" :dateText="dateText" @selected="validaDate" :validate="validate"></datepicker>
